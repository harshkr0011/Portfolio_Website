    ...
    <div className={`relative w-[500px] ${className}`}>
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div
              className={`p-4 bg-[#111] rounded-lg ${selectedIndex === index ? "bg-[#222]" : ""} ${itemClassName} transition-transform duration-200 hover:scale-105 hover:bg-gradient-to-r hover:from-cyan-400 hover:to-blue-500`}
            >
